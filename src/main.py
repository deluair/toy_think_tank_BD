...
def main(args: List[str] = None) -> None:
    """
    Main function to run the data generation and plotting scripts based on command-line arguments.
    ...
    if parsed_args.all or parsed_args.generate_data:
    ...
    if parsed_args.all or parsed_args.generate_plots:
    ...
    if not (parsed_args.generate_data or parsed_args.generate_plots or parsed_args.all):
